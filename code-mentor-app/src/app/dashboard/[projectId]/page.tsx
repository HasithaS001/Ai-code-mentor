      ...
      <div className="dashboard-content grid grid-cols-12 gap-4 p-4 w-full">
        ...
        <div className="col-span-7 bg-gray-900 rounded-4xl border border-gray-700/50 overflow-hidden">
          {selectedFile ? (
            ...
            <div className="h-full flex items-center justify-center rounded-4xl bg-gray-900 text-gray-300">
              <div className="text-center max-w-md px-8">
                <div className="mb-8 flex justify-center">
                  <div className="relative w-64 h-64">
                    <div className="absolute inset-0 bg-gradient-to-br from-teal-900/70 to-gray-800 rounded-2xl shadow-2xl transform -rotate-2"></div>
                    <div className="absolute inset-0 bg-gray-800 rounded-2xl shadow-lg transform rotate-1 border border-gray-700">
                      <div className="p-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="h-3 bg-teal-800 rounded-full w-1/2"></div>
                          <div className="h-3 bg-gray-700 rounded-full w-5/6"></div>
                          <div className="h-3 bg-teal-800 rounded-full w-2/3"></div>
                          <div className="h-3 bg-gray-700 rounded-full w-3/5"></div>
                          <div className="h-3 bg-teal-800 rounded-full w-4/5"></div>
                        </div>
                      </div>
                    </div>
                    <div className="absolute -bottom-4 -right-4 w-12 h-12 bg-teal-600 rounded-full flex items-center justify-center shadow-lg">
                      <svg
